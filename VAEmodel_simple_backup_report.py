...
class VAEmodangauggroupedsimple(nn.Module):
    def __init__(self, args, x_dim):
        super(VAEmodangauggroupedsimple, self).__init__()
...
class VAEmodcoordlong(nn.Module):
    def __init__(self, args, x_dim):
        super(VAEmodcoordlong, self).__init__()
