...
class VAEparent(nn.Module):
    def __init__(self, args, x_dim, bfixlogvar, bfixenclogvar=False):
...
class VARmdAngAugGrouped(VAEparent):
    def __init__(self, args, x_dim, bfixlogvar, bfixenclogvar=False):
        super(VARmdAngAugGrouped, self).__init__(args, x_dim, bfixlogvar, bfixenclogvar)
...
class VARmdDEP(VAEparent):
    def __init__(self, args, x_dim, bfixlogvar, bfixenclogvar=False):
        super(VARmdDEP, self).__init__(args, x_dim, bfixlogvar, bfixenclogvar)
...
class VARmd(VAEparent):
    def __init__(self, args, x_dim, bfixlogvar, bfixenclogvar=False):
        super(VARmd, self).__init__(args, x_dim, bfixlogvar, bfixenclogvar)
        ...
        self.enc_fc3muvar = nn.Linear(dim_intermed_enc, dim_intermed_enc)
...
class VARmdSepDec(VAEparent):
    def __init__(self, args, x_dim, bfixlogvar, bfixenclogvar=False):
        super(VARmdSepDec, self).__init__(args, x_dim, bfixlogvar, bfixenclogvar)
...
class VARmixturecomplexDeep(VAEparent):
    def __init__(self, args, x_dim, bfixlogvar, bfixenclogvar=False):
        super(VARmixturecomplexDeep, self).__init__(args, x_dim, bfixlogvar, bfixenclogvar)
...
class VARmixturecomplexNotWorking(VAEparent):
    def __init__(self, args, x_dim, bfixlogvar, bfixenclogvar=False):
        super(VARmixturecomplex, self).__init__(args, x_dim, bfixlogvar, bfixenclogvar)
...
class VARmixture(VAEparent):
    def __init__(self, args, x_dim, bfixlogvar, bfixenclogvar=False):
        super(VARmixture, self).__init__(args, x_dim, bfixlogvar, bfixenclogvar)
...
class VARmod(VAEparent):
    def __init__(self, args, x_dim, bfixlogvar, bfixenclogvar=False):
        super(VARmod, self).__init__(args, x_dim, bfixlogvar, bfixenclogvar)
